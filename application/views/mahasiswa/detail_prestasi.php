                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="nav-icon fas fa-fw fa-university"></i></span>
                                    </div>
                                    <input type="text" class="form-control" style="background: rgba(233, 236, 239, 0.307);" readonly value="<?= $prestasi['nama_fakultas']; ?>" aria-label="Input group example" aria-describedby="btnGroupAddonFakultas">
                                </div>
                            </div>

                                ...
                                <tbody>
                                    ...
                                    foreach ($prestasi as $val) { ?>
                                        <tr>
                                            ...
                                            <td><?= $val['tahun']; ?></td>
                                            <td class="text-center" width="150"> <a href="<?= site_url('Prestasi/detail/' . md5($val['id_prestasi'])) ?>">
                                                ...
                                                <a href="<?= site_url('Prestasi/deleteKelompok/' . ($val['id_prestasi'])); ?>" class="btn btn-sm btn-danger tombol-hapus">

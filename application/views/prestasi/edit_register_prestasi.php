            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" id="quickForm" action="<?= site_url('Prestasi/' . $form . '/' . md5($id_prestasi['id_prestasi'])); ?>" method="POST" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    $(".id_user").select2({
        ...
        theme: 'bootstrap4',
        ajax: {
            url: "<?php echo base_url(); ?>Prestasi/findMahasiswa",
            type: "post",
            dataType: 'json',
            delay: 250,
    ...
    $(".id_pembimbing").select2({
        ...
        theme: 'bootstrap4',
        ajax: {
            url: "<?php echo base_url(); ?>Prestasi/findPembimbing",
            type: "post",
            dataType: 'json',
            delay: 250,
            data: function(params) {

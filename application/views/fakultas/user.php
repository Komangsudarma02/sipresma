                                    ...
                                    foreach ($users as $val) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="<?= site_url('DataUser/delete_user/' . md5($val['id_user'])) ?>" width="50px" class="btn btn-sm bg-danger tombol-hapus">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="quickForm" action="<?= site_url('DataUser/daftarUser'); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-check" id="is_active">
                        <input id="is_active" type="checkbox" value="1" name="is_active" id="is_active" checked>
...
<script>
    ...
    $('.tampilUserUbah').on('click', function() {
        ...
        $('.modal-body form').attr('action', '<?= base_url('DataUser/saveUpdateUser') ?>');
        ...
        $.ajax({
            url: '<?= base_url('DataUser/getUbahUser') ?>',
            data: {
                id_user: id_user
            },
            method: 'post',
    ...
    $("#id_fakultas").change(function() {
        ...
        $.ajax({
            url: '<?= base_url('DataUser/getJurusan') ?>',
            method: "POST",
            data: {
